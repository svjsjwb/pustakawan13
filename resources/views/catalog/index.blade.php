...
<section class="page" id="page-catalog">
    ...
    <div class="catalog-header">
        <div>
            ...
            <h1>Katalog Buku</h1>
            <p>
                Telusuri seluruh koleksi perpustakaan berdasarkan judul, kategori, atau ketersediaan stok.
            </p>
        </div>
    </div>
    ...
    <div class="book-grid">
        ...
        <div
            ...
            <div class="book-cover {{ $book->cover ? 'has-image' : '' }}">
                @if($book->cover)
                    <img src="{{ asset('storage/' . $book->cover) }}" alt="{{ $book->title }}" class="book-cover-img">
                @endif
            </div>
            ...
            <div class="book-info">
                ...
                <div class="book-meta">
                    ...
                    @if($book->available_stock > 0)
                        <span class="book-status available">Tersedia ({{ $book->available_stock }})</span>
                    @else
    ...
    <div class="catalog-modal-container">
        ...
        <div class="catalog-modal-body">
            ...
            <div class="catalog-modal-cover">
                ...
                <img id="modal-cover-image" src="#" alt="Cover Buku" style="display:none; width: 170px; height: 235px; object-fit: cover; border-radius: 10px; box-shadow: -6px 12px 25px rgba(0,0,0,0.20);">
            </div>
