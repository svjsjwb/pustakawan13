    ...
    ========================================================== --}}
        <div class="report-filter-box">
            ...
            <div class="filter-period-badge">
                <span>🗓️ Periode: <strong>{{ $reportMonthLabel }}</strong></span>
            </div>
        </div>
    ...
    <script>
        ...
        function downloadReport(button) {
            ...
            try {
                ...
                const headers = [
                    ['No', 'Nama Anggota', 'Kode', 'Buku yang Dipinjam', 'Tgl Pinjam', 'Jatuh Tempo', 'Status']
                ];
                ...
                doc.autoTable({
                    ...
                    didDrawPage: function(data) {
                        ...
                        doc.text('Dokumen ini dicetak otomatis oleh Sistem Perpustakaan Tiga Serangkai.', 14,
                            290);
