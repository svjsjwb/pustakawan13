...
{
    /**
     * Sinkronisasi status member berdasarkan aktivitas.
     *
     * Member AKTIF jika:
     * - memiliki peminjaman yang belum dikembalikan
     * ATAU
     * - memiliki reservasi yang belum selesai
     *
     * Member NONAKTIF jika tidak memiliki keduanya.
     */
    ...
    public function update(
        ...
        /*
        |--------------------------------------------------------------------------
        | PASTIKAN STATUS TETAP SESUAI AKTIVITAS
        |--------------------------------------------------------------------------
        */
