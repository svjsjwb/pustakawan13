...
class LibraryZoneSeeder extends Seeder
{
    ...
    {
        $floor1 = LibraryFloor::where('floor_number', 1)->firstOrFail();
        $floor2 = LibraryFloor::where('floor_number', 2)->firstOrFail();

        LibraryZone::updateOrCreate(
            ['library_floor_id' => $floor1->id, 'code' => 'A'],
            [
        ...
        LibraryZone::updateOrCreate(
            ['library_floor_id' => $floor1->id, 'code' => 'B'],
            [
        ...
        LibraryZone::updateOrCreate(
            ['library_floor_id' => $floor1->id, 'code' => 'C'],
            [
                'name' => 'Koleksi Umum',
